 ...
 * @LastEditTime: 2021-12-22 10:33:47
 * @Description: 
 */
...
const templateUrls = [{
    ...
    url: 'direct:https://github.com/Sarlaka/react-app-redux-template.git#master'
}, {
    name: 'vue3+vue-router',
    url: 'direct:https://github.com/Sarlaka/vue3.x-router-template.git#master'
}, {
    name: 'vue2+vue-router+vuex',
    url: 'direct:https://github.com/Sarlaka/vue2.x-router-vuex-template.git#master'
},{
    name: 'uni-template-vue',
    url: 'direct:https://github.com/Sarlaka/uni-template-vue.git#main'
}]
